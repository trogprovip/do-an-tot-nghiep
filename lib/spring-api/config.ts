// Cấu hình API Backend Spring Boot
export const SPRING_API_CONFIG = {
  BASE_URL: process.env.NEXT_PUBLIC_SPRING_API_URL || 'http://localhost:8080/api',
  TIMEOUT: 30000,
};
...
export const SPRING_API_ENDPOINTS = {
  ...
  MOVIE_DATES: (id: number) => `/movies/${id}/dates`,
